...
var listre = [
  ...
  "images/lowtarot/quenn of wands.png",
...
String username = "";
String usermail = "";
String userdate = "verilmedi";
String userwork = "verilmedi";
String usercinsiyet = "verilmedi";
String useriliski = "verilmedi";
...
class _DesteScreenState extends State<DesteScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 500), () {
      // ListView'in belirli bir konuma kaydırılması
      _scrollController.animateTo(
        500.0, // Kaydırılacak konum
  ...
  void didChangeDependencies() {
    ...
    if (args["bilgiler"] != null) {
      username = args["bilgiler"]["isim"];
      userdate = args["bilgiler"]["tar"];
      usercinsiyet = args["bilgiler"]["cins"];
      useriliski = args["bilgiler"]["ilis"];
      userwork = args["bilgiler"]["cal"];
    }
                    ...
                    child: Column(
                      children: [
                        Text(
                            ...
                            username + ", lütfen üç kart seçiniz."),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Container(height: widget.h / 3, width: widget.w),
                            Container(
                              height: widget.h / 3,
                              width: (7 *
                                      (widget.w * 12 / 30 +
                                      ...
                                      if (true) {
                                        ...
                                        await _firestore
                                          ...
                                          "prompt": f +
                                              ...
                                              username +
                                              " onunla konuşuyomuş gibi yorumla ama samimi olma ve sadece ismiyle hitap et o sadece bir müşteri.(200 kelime civarı olun) (müşterinin bilgiler: [cinsiyet: " +
                                              usercinsiyet +
                                              "], [doğumtarihi: " +
                                              userdate +
                                              "], [çalışma durumu: " +
...
class _SingleCardState extends State<SingleCard> {
  ...
  funcer() {
    ...
    if (x + (widget.widget.w * 18 / 30) > 0 &&
        x < widget.widget.w + (widget.widget.w * 6 / 30)) {
      setState(() {
        angle =
            (x - ((widget.widget.w / 2) - (widget.widget.w * 6 / 30))) / 2500;
        topp = (widget.h / 1000) +
            ((((x - ((widget.widget.w / 2) - (widget.widget.w * 6 / 30))))
                    .abs()) /
                30);
      });
    }
